const API_KEY = 'api_key=f9d5ad97ff7471a27663c6c7094af70c';
      ...
      if(videoData.results.length > 0){
        ...
        videoData.results.forEach((video, idx) => {
          ...
          if(site == 'YouTube'){
            ...
            embed.push(`
              <iframe width="560" height="315" src="https://www.youtube.com/embed/${key}" name="${name}" class="embed hide" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
